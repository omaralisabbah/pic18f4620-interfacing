...
# 8 "ecu_layer/seven_segment/../../mcal_layer/gpio/../std_libraries.h" 2
...
# 9 "ecu_layer/seven_segment/../../mcal_layer/gpio/../std_libraries.h" 2
...
# 10 "ecu_layer/seven_segment/../../mcal_layer/gpio/../std_libraries.h" 2
# 7 "ecu_layer/seven_segment/../../mcal_layer/gpio/../mcal_std_types.h" 2
...
# 6 "ecu_layer/seven_segment/../../mcal_layer/gpio/../compiler.h" 2
# 8 "ecu_layer/seven_segment/../../mcal_layer/gpio/../mcal_std_types.h" 2
...
# 7 "ecu_layer/seven_segment/../../mcal_layer/gpio/hal_gpio.h" 2
# 1 "ecu_layer/seven_segment/../../mcal_layer/gpio/../device_config.h" 1
# 8 "ecu_layer/seven_segment/../../mcal_layer/gpio/hal_gpio.h" 2
# 1 "ecu_layer/seven_segment/../../mcal_layer/gpio/hal_gpio_cfg.h" 1
# 9 "ecu_layer/seven_segment/../../mcal_layer/gpio/hal_gpio.h" 2
# 30 "ecu_layer/seven_segment/../../mcal_layer/gpio/hal_gpio.h"
typedef enum {
    GPIO_LOW,
    GPIO_HIGH
}LOGIC_T;
...
# 6 "ecu_layer/seven_segment/ecu_seven_seg.h" 2
# 1 "ecu_layer/seven_segment/ecu_seven_seg_cfg.h" 1
# 7 "ecu_layer/seven_segment/ecu_seven_seg.h" 2
...
# 3 "ecu_layer/seven_segment/ecu_seven_seg.c" 2
...
STD_RETURN_TYPE SEVEN_SEGMENT_INITIALIZE(const SEGMENT_T *_seg) {
    ...
    if(((void*)0) == _seg) {
        ...
        RET = PIN_INITIALIZE(&(_seg->SEGMENT_PINS[0]));
        RET = PIN_INITIALIZE(&(_seg->SEGMENT_PINS[1]));
        RET = PIN_INITIALIZE(&(_seg->SEGMENT_PINS[2]));
        RET = PIN_INITIALIZE(&(_seg->SEGMENT_PINS[3]));
    }
    return RET;
}
...
STD_RETURN_TYPE SEVEN_SEGMENT_WRITE_NUMBER(const SEGMENT_T *_seg, uint8 number) {
    ...
    if((((void*)0) == _seg) && (number > 9)) {
        ...
        RET = GPIO_PIN_WRITE_LOGIC(&(_seg->SEGMENT_PINS[0]), number & 0x01);
        RET = GPIO_PIN_WRITE_LOGIC(&(_seg->SEGMENT_PINS[1]), (number >> 1) & 0x01);
        RET = GPIO_PIN_WRITE_LOGIC(&(_seg->SEGMENT_PINS[2]), (number >> 2) & 0x01);
        RET = GPIO_PIN_WRITE_LOGIC(&(_seg->SEGMENT_PINS[3]), (number >> 3) & 0x01);
    }
    return RET;
}
