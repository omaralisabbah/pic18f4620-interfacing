...
# 8 "mcal_layer/ccp/../std_libraries.h" 2
...
# 9 "mcal_layer/ccp/../std_libraries.h" 2
...
# 10 "mcal_layer/ccp/../std_libraries.h" 2
# 7 "mcal_layer/ccp/../mcal_std_types.h" 2
...
# 6 "mcal_layer/ccp/../compiler.h" 2
# 8 "mcal_layer/ccp/../mcal_std_types.h" 2
...
# 8 "mcal_layer/ccp/../../mcal_Layer/gpio/hal_gpio.h" 2
# 1 "mcal_layer/ccp/../../mcal_Layer/gpio/hal_gpio_cfg.h" 1
# 9 "mcal_layer/ccp/../../mcal_Layer/gpio/hal_gpio.h" 2
# 30 "mcal_layer/ccp/../../mcal_Layer/gpio/hal_gpio.h"
typedef enum {
    GPIO_LOW,
    GPIO_HIGH
}LOGIC_T;
...
# 1 "mcal_layer/ccp/../../mcal_Layer/interrupt/mcal_interrupt_cfg.h" 1
# 7 "mcal_layer/ccp/../../mcal_Layer/interrupt/mcal_interrupt_config.h" 2
# 82 "mcal_layer/ccp/../../mcal_Layer/interrupt/mcal_interrupt_config.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HIGH_PRIORITY
}interrupt_priority_cfg;
# 6 "mcal_layer/ccp/../../mcal_Layer/interrupt/mcal_internal_interrupt.h" 2
# 9 "mcal_layer/ccp/hal_ccp.h" 2
# 1 "mcal_layer/ccp/ccp_cfg.h" 1
# 10 "mcal_layer/ccp/hal_ccp.h" 2
# 67 "mcal_layer/ccp/hal_ccp.h"
typedef enum{
...
STD_RETURN_TYPE CCP1_IsCapturedDataReady(uint8 *_capture_status);
STD_RETURN_TYPE CCP1_Capture_Mode_Read_Value(uint16 *capture_value);
# 3 "mcal_layer/ccp/hal_ccp.c" 2
...
STD_RETURN_TYPE CCP_Init(const ccp_t *_ccp_obj) {
    ...
    if(((void*)0) == _ccp_obj){
        ...
        RET = PIN_INITIALIZE(&(_ccp_obj->ccp_pin));
...
# 282 "mcal_layer/ccp/hal_ccp.c"
static void CCP_Interrupt_Config(const ccp_t *_ccp_obj){

    (PIE1bits.CCP1IE = 1);
    (PIR1bits.CCP1IF = 0);
    CCP1_InterruptHandler = _ccp_obj->CCP1_InterruptHandler;
# 300 "mcal_layer/ccp/hal_ccp.c"
    (INTCONbits.GIE = 1);
    (INTCONbits.PEIE = 1);
