...
# 8 "mcal_layer/interrupt/../std_libraries.h" 2
...
# 9 "mcal_layer/interrupt/../std_libraries.h" 2
...
# 7 "mcal_layer/interrupt/../mcal_std_types.h" 2
...
# 6 "mcal_layer/interrupt/../compiler.h" 2
# 8 "mcal_layer/interrupt/../mcal_std_types.h" 2
...
# 6 "mcal_layer/interrupt/mcal_interrupt_config.h" 2
# 1 "mcal_layer/interrupt/mcal_interrupt_cfg.h" 1
# 7 "mcal_layer/interrupt/mcal_interrupt_config.h" 2
...
# 8 "mcal_layer/interrupt/../gpio/hal_gpio.h" 2
# 1 "mcal_layer/interrupt/../gpio/hal_gpio_cfg.h" 1
# 9 "mcal_layer/interrupt/../gpio/hal_gpio.h" 2
...
# 8 "mcal_layer/interrupt/mcal_interrupt_config.h" 2
# 82 "mcal_layer/interrupt/mcal_interrupt_config.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HIGH_PRIORITY
}interrupt_priority_cfg;
# 6 "mcal_layer/interrupt/mcal_external_interrupt.h" 2
# 126 "mcal_layer/interrupt/mcal_external_interrupt.h"
...
# 164 "mcal_layer/interrupt/mcal_external_interrupt.h"
...
# 3 "mcal_layer/interrupt/mcal_external_interrupt.c" 2
...
# 142 "mcal_layer/interrupt/mcal_external_interrupt.c"
...
# 178 "mcal_layer/interrupt/mcal_external_interrupt.c"
...
STD_RETURN_TYPE Interrupt_RBx_Init(const interrupt_RBx_t *int_obj) {
    ...
    if(((void*)0) == int_obj) {
        ...
        (INTCONbits.RBIE = 0);
        (INTCONbits.RBIF = 0);
# 217 "mcal_layer/interrupt/mcal_external_interrupt.c"
        (INTCONbits.GIE = 1);
        (INTCONbits.PEIE = 1);
    ...
    if(((void*)0) == int_obj) {
        ...
        switch(int_obj->source) {
            case INTERRUPT_EXTERNAL_INT0 :
                ...
                (INTCONbits.INT0IE = 1); RET = (STD_RETURN_TYPE)0x01; break;
            case INTERRUPT_EXTERNAL_INT1 :
# 298 "mcal_layer/interrupt/mcal_external_interrupt.c"
                (INTCONbits.GIE = 1);
                (INTCONbits.PEIE = 1);

                (INTCON3bits.INT1IE = 1); RET = (STD_RETURN_TYPE)0x01; break;
            case INTERRUPT_EXTERNAL_INT2 :
# 313 "mcal_layer/interrupt/mcal_external_interrupt.c"
                (INTCONbits.GIE = 1);
                (INTCONbits.PEIE = 1);

                (INTCON3bits.INT2IE = 1); RET = (STD_RETURN_TYPE)0x01; break;
...
static STD_RETURN_TYPE Interrupt_INTx_Disable(const interrupt_INTx_t *int_obj) {
    ...
    if(((void*)0) == int_obj) {
        ...
        switch(int_obj->source) {
            case INTERRUPT_EXTERNAL_INT0 :
                (INTCONbits.INT0IE = 0); RET = (STD_RETURN_TYPE)0x01; break;
            case INTERRUPT_EXTERNAL_INT1 :
                (INTCON3bits.INT1IE = 0); RET = (STD_RETURN_TYPE)0x01; break;
            case INTERRUPT_EXTERNAL_INT2 :
                (INTCON3bits.INT2IE = 0); RET = (STD_RETURN_TYPE)0x01; break;
            default: RET = (STD_RETURN_TYPE)0x00;
        }
    }
    return RET;
...
static STD_RETURN_TYPE Interrupt_INTx_Clear_Flag(const interrupt_INTx_t *int_obj) {
    ...
    if(((void*)0) == int_obj) {
        ...
        switch(int_obj->source) {
            case INTERRUPT_EXTERNAL_INT0 :
                (INTCONbits.INT0IF = 0); RET = (STD_RETURN_TYPE)0x01; break;
            case INTERRUPT_EXTERNAL_INT1 :
                (INTCON3bits.INT1IF = 0); RET = (STD_RETURN_TYPE)0x01; break;
            case INTERRUPT_EXTERNAL_INT2 :
                (INTCON3bits.INT2IF = 0); RET = (STD_RETURN_TYPE)0x01; break;
            default: RET = (STD_RETURN_TYPE)0x00;
        }
    }
    return RET;
...
static STD_RETURN_TYPE INT0_SetInterruptHandler(void (* InterruptHandler)(void)) {
    ...
    if(((void*)0) == InterruptHandler) {
        ...
        INT0_InterruptHandler = InterruptHandler; RET = (STD_RETURN_TYPE)0x01;
    }
    return RET;
}
...
static STD_RETURN_TYPE INT1_SetInterruptHandler(void (* InterruptHandler)(void)) {
    ...
    if(((void*)0) == InterruptHandler) {
        ...
        INT1_InterruptHandler = InterruptHandler; RET = (STD_RETURN_TYPE)0x01;
    }
    return RET;
}
...
static STD_RETURN_TYPE INT2_SetInterruptHandler(void (* InterruptHandler)(void)) {
    ...
    if(((void*)0) == InterruptHandler) {
        ...
        INT2_InterruptHandler = InterruptHandler; RET = (STD_RETURN_TYPE)0x01;
    }
    return RET;
}
    ...
    if(((void*)0) == int_obj) {
        ...
        switch(int_obj->source) {
            case INTERRUPT_EXTERNAL_INT0 :
                ...
                RET = (STD_RETURN_TYPE)0x01; break;
            case INTERRUPT_EXTERNAL_INT1 :
