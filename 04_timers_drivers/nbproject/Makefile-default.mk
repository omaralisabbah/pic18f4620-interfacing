...
FINAL_IMAGE=${DISTDIR}/03_timers_drivers.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=ecu_layer/button/ecu_button.c ecu_layer/dc_motor/ecu_dc_motor.c ecu_layer/keypad/ecu_keypad.c ecu_layer/lcd/ecu_lcd.c ecu_layer/led/ecu_led.c ecu_layer/relay/ecu_relay.c ecu_layer/seven_segment/ecu_seven_seg.c mcal_layer/interrupt/mcal_internal_interrupt.c mcal_layer/interrupt/mcal_external_interrupt.c mcal_layer/interrupt/mcal_interrupt_manager.c mcal_layer/adc/hal_adc.c mcal_layer/eeprom/hal_eeprom.c mcal_layer/gpio/hal_gpio.c mcal_layer/device_config.c main.c mcal_layer/timer0/hal_timr0.c mcal_layer/timer1/hal_timr1.c mcal_layer/timer2/hal_timr2.c mcal_layer/timer3/hal_timr3.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/ecu_layer/button/ecu_button.p1 ${OBJECTDIR}/ecu_layer/dc_motor/ecu_dc_motor.p1 ${OBJECTDIR}/ecu_layer/keypad/ecu_keypad.p1 ${OBJECTDIR}/ecu_layer/lcd/ecu_lcd.p1 ${OBJECTDIR}/ecu_layer/led/ecu_led.p1 ${OBJECTDIR}/ecu_layer/relay/ecu_relay.p1 ${OBJECTDIR}/ecu_layer/seven_segment/ecu_seven_seg.p1 ${OBJECTDIR}/mcal_layer/interrupt/mcal_internal_interrupt.p1 ${OBJECTDIR}/mcal_layer/interrupt/mcal_external_interrupt.p1 ${OBJECTDIR}/mcal_layer/interrupt/mcal_interrupt_manager.p1 ${OBJECTDIR}/mcal_layer/adc/hal_adc.p1 ${OBJECTDIR}/mcal_layer/eeprom/hal_eeprom.p1 ${OBJECTDIR}/mcal_layer/gpio/hal_gpio.p1 ${OBJECTDIR}/mcal_layer/device_config.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/mcal_layer/timer0/hal_timr0.p1 ${OBJECTDIR}/mcal_layer/timer1/hal_timr1.p1 ${OBJECTDIR}/mcal_layer/timer2/hal_timr2.p1 ${OBJECTDIR}/mcal_layer/timer3/hal_timr3.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/ecu_layer/button/ecu_button.p1.d ${OBJECTDIR}/ecu_layer/dc_motor/ecu_dc_motor.p1.d ${OBJECTDIR}/ecu_layer/keypad/ecu_keypad.p1.d ${OBJECTDIR}/ecu_layer/lcd/ecu_lcd.p1.d ${OBJECTDIR}/ecu_layer/led/ecu_led.p1.d ${OBJECTDIR}/ecu_layer/relay/ecu_relay.p1.d ${OBJECTDIR}/ecu_layer/seven_segment/ecu_seven_seg.p1.d ${OBJECTDIR}/mcal_layer/interrupt/mcal_internal_interrupt.p1.d ${OBJECTDIR}/mcal_layer/interrupt/mcal_external_interrupt.p1.d ${OBJECTDIR}/mcal_layer/interrupt/mcal_interrupt_manager.p1.d ${OBJECTDIR}/mcal_layer/adc/hal_adc.p1.d ${OBJECTDIR}/mcal_layer/eeprom/hal_eeprom.p1.d ${OBJECTDIR}/mcal_layer/gpio/hal_gpio.p1.d ${OBJECTDIR}/mcal_layer/device_config.p1.d ${OBJECTDIR}/main.p1.d ${OBJECTDIR}/mcal_layer/timer0/hal_timr0.p1.d ${OBJECTDIR}/mcal_layer/timer1/hal_timr1.p1.d ${OBJECTDIR}/mcal_layer/timer2/hal_timr2.p1.d ${OBJECTDIR}/mcal_layer/timer3/hal_timr3.p1.d
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/03_timers_drivers.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/03_timers_drivers.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/03_timers_drivers.${IMAGE_TYPE}.map  -D__DEBUG=1  -mdebugger=none  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mno-default-config-bits -std=c99 -gcoff -mstack=compiled:auto:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/03_timers_drivers.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} ${DISTDIR}/03_timers_drivers.${IMAGE_TYPE}.hex 
	
	
else
${DISTDIR}/03_timers_drivers.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/03_timers_drivers.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mno-default-config-bits -std=c99 -gcoff -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/03_timers_drivers.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
