...
# 6 "mcal_layer/interrupt/mcal_interrupt_manager.h" 2
...
# 3 "mcal_layer/interrupt/mcal_interrupt_manager.c" 2
...
void __attribute__((picinterrupt(("")))) InterruptManager(void) {
    ...
    if((1 == INTCONbits.RBIE) && (1 == INTCONbits.RBIF) && (PORTBbits.RB4 == GPIO_HIGH)
            && (RB4_Flag == 1)) {
        RB4_Flag = 0;
        RB4_ISR(0);
    } else { }
    ...
    if((1 == INTCONbits.RBIE) && (1 == INTCONbits.RBIF) && (PORTBbits.RB4 == GPIO_LOW)
            && (RB4_Flag == 1)) {
        RB4_Flag = 0;
        RB4_ISR(1);
    } else { }
